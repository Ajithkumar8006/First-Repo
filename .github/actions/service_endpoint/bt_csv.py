...
# Example usage
json_file = '.github/actions/service_endpoint/{app_online}_bt.json'  # Path to your JSON file
csv_file = '.github/actions/service_endpoint/{app_online}_bt.csv'    # Desired output CSV file
