...
python appdynamics_api.py --cred .github/actions/credentials.ini --debug 5 --output json --app "Patient_Online_Services_Portal_Test" all_business_transactions_list
